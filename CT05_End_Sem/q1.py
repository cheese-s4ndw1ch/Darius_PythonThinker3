...
customer_spending = {
    "Alice": 950, "Bob": 1200, "Charlie": 500, "Diana": 1800, 
    "Ethan": 2200, "Fiona": 700, "John": 685, "Hor Kee": 1389, 
    "Siew Ling": 235, "Matt": 452, "Kristen": 985, "Johnson": 785, 
    "Charles": 2352, "Tommy": 741, "Laura": 689
}
...
for name, amount in customer_spending.items():
    if amount > 1000:
        ...
        needed = 1001 - amount
        print(f"Hi {name}, spend ${needed} more to become a VIP member!")